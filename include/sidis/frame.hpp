...
math::Transform4 target_from_lepton(kin::Kinematics kin);
math::Transform4 lepton_from_target(kin::Kinematics kin);

math::Transform4 target_from_hadron(kin::Kinematics kin);
math::Transform4 hadron_from_target(kin::Kinematics kin);

math::Transform4 target_from_virt_photon(kin::Kinematics kin);
math::Transform4 virt_photon_from_target(kin::Kinematics kin);

math::Transform4 target_from_real_photon(kin::KinematicsRad kin);
math::Transform4 real_photon_from_target(kin::KinematicsRad kin);

math::Transform4 target_from_shift(kin::KinematicsRad kin);
math::Transform4 shift_from_target(kin::KinematicsRad kin);
math::Transform4 hadron_from_shift(kin::KinematicsRad kin);
math::Transform4 shift_from_hadron(kin::KinematicsRad kin);
